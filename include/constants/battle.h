...
#define BATTLE_TYPE_TWO_OPPONENTS    0x10000000
...
#define STATUS3_DOWNLOAD                0x400000
...
#define SIDE_STATUS_AURORA_VEIL      (1 << 2)
#define SIDE_STATUS_TAILWIND         (1 << 3)
