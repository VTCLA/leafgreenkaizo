...
extern const u8 gFile_graphics_items_icons_normal_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_normal_gem_palette[];
extern const u8 gFile_graphics_items_icons_fighting_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_fighting_gem_palette[];
extern const u8 gFile_graphics_items_icons_flying_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_flying_gem_palette[];
extern const u8 gFile_graphics_items_icons_poison_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_poison_gem_palette[];
extern const u8 gFile_graphics_items_icons_ground_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_ground_gem_palette[];
extern const u8 gFile_graphics_items_icons_rock_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_rock_gem_palette[];
extern const u8 gFile_graphics_items_icons_bug_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_bug_gem_palette[];
extern const u8 gFile_graphics_items_icons_ghost_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_ghost_gem_palette[];
extern const u8 gFile_graphics_items_icons_steel_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_steel_gem_palette[];
extern const u8 gFile_graphics_items_icons_fire_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_fire_gem_palette[];
extern const u8 gFile_graphics_items_icons_water_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_water_gem_palette[];
extern const u8 gFile_graphics_items_icons_grass_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_grass_gem_palette[];
extern const u8 gFile_graphics_items_icons_psychic_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_psychic_gem_palette[];
extern const u8 gFile_graphics_items_icons_electric_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_electric_gem_palette[];
extern const u8 gFile_graphics_items_icons_ice_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_ice_gem_palette[];
extern const u8 gFile_graphics_items_icons_dragon_gem_sheet[];
extern const u8 gFile_graphics_items_icon_palettes_dragon_gem_palette[];
extern const u8 gFile_graphics_items_icons_dark_gem_sheet[];
