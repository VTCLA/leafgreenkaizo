...
extern const u8 BattleScript_SuccessForceOutRedCard[];
...
extern const u8 BattleScript_StealthRocksOnAttacker[];
extern const u8 BattleScript_StealthRocksOnTarget[];
...
extern const u8 BattleScript_StealthRocksFree[];
extern const u8 BattleScript_ToxicSpikesFree[];
extern const u8 BattleScript_StickyWebFree[];
extern const u8 BattleScript_AbsorbedToxicSpikes[];
...
extern const u8 BattleScript_StealthRocksOnFaintedBattler[];
...
extern const u8 BattleScript_ThroatSpray[];
extern const u8 BattleScript_AirBalloonFloat[];
extern const u8 BattleScript_AirBalloonPop[];
