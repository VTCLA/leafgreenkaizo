...
static const u8 sText_PkmnsXActivated[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nactivated!");
...
static const u8 sText_PointedStonesFloat[] =_("Pointed stone float around\nthe opponent's side!");
static const u8 sText_StickyWebLaid[] =_("A sticky web was laid out on\nthe opponent's side!");
static const u8 sText_PkmnHurtBySpikes[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is hurt\nby SPIKES!");
static const u8 sText_PointedStonesDugInto[] = _("Pointed stones dug into\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnCaughtInWeb[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} was caught\nin a STICKY WEB!");
static const u8 sText_WebsLoweredSpeed[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s SPEED fell!");
static const u8 sText_ToxicSpikesPoisoned[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} was\npoisoned!");
static const u8 sText_ToxicSpikesBadlyPoisoned[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} was\nbadly poisoned!");
...
static const u8 sText_PkmnBlewAwayRocks[] = _("{B_ATK_NAME_WITH_PREFIX} blew away\nSTEALTH ROCK!");
static const u8 sText_PkmnBlewAwayTSpikes[] = _("{B_ATK_NAME_WITH_PREFIX} blew away\nTOXIC SPIKES!");
static const u8 sText_PkmnBlewAwayWebs[] = _("{B_ATK_NAME_WITH_PREFIX} blew away\nSTICKY WEB!");
static const u8 sText_PkmnAbsorbedPoisonSpikes[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} absorbed\nthe poison spikes.");
...
static const u8 sText_PkmnItemPreventsStatLoss[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nprevents stat loss!");
...
static const u8 sText_HarvestedItem[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} harvested\nits {B_LAST_ITEM}!");
static const u8 sText_PreventedFromWorking[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nprevented {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s\l{B_BUFF1} from working!");
static const u8 sText_PreventedByItem[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nprevented {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s\l{B_BUFF1} from working!");
...
static const u8 sText_PkmnsSpeedUp[] = _("{B_DEF_NAME_WITH_PREFIX}'s SPEED\nrose!");
static const u8 sText_PkmnsAttackUp[] = _("{B_DEF_NAME_WITH_PREFIX}'s ATTACK\nrose!");
static const u8 sText_PkmnsSpecialAttackUp[] = _("{B_DEF_NAME_WITH_PREFIX}'s SP. ATK\nrose!");
...
const u8 *const gBattleStringsTable[] = {
    ...
    [STRINGID_PKMNSSPEEDUP - 12]                  = sText_PkmnsSpeedUp,
    ...
    [STRINGID_STICKYWEBLAID - 12]                 = sText_StickyWebLaid,
    [STRINGID_POINTEDSTONESDUGINTO - 12]          = sText_PointedStonesDugInto,
    [STRINGID_PKMNBLEWAWAYROCKS - 12]             = sText_PkmnBlewAwayRocks,
    [STRINGID_PKMNBLEWAWAYTSPIKES - 12]           = sText_PkmnBlewAwayTSpikes,
    [STRINGID_PKMNBLEWAWAYWEBS - 12]              = sText_PkmnBlewAwayWebs,
    [STRINGID_WEBSLOWEREDSPEED - 12]              = sText_WebsLoweredSpeed,
