...
static const u8 sNaturalCureDescription[] = _("Cures status upon switching out.");
...
static const u8 sFilterDescription[] = _("Takes less super effective damage.");
...
static const u8 sDrySkinDescription[] = _("Heat lowers HP. Water restores HP.");
static const u8 sSolidRockDescription[] = _("Takes less super effective damage.");
static const u8 sMotorDriveDescription[] = _("ELECTRIC moves raise SPEED.");
static const u8 sStormDrainDescription[] = _("Draws in WATER moves.");
static const u8 sSapSipperDescription[] = _("GRASS moves raise ATTACK");
static const u8 sFurCoatDescription[] = _("Halves incoming physical damage.");
static const u8 sNormalizeDescription[] = _("Turns moves to NORMAL type.");
static const u8 sPixilateDescription[] = _("NORMAL moves become FAIRY type.");
static const u8 sSheerForceDescription[] = _("Lose bonus effects to gain damage.");
...
static const u8 sPoisonHealDescription[] = _("Restores HP while poisoned.");
static const u8 sSuperLuckDescription[] = _("Boosts critical hit ratio.");
static const u8 sScrappyDescription[] = _("Ignores GHOST type's immunities.");
static const u8 sRecklessDescription[] = _("Powers up recoil moves.");
static const u8 sSandRushDescription[] = _("Raises SPEED in sandstorm.");
static const u8 sSandForceDescription[] = _("Boosts certain moves in sandstorm.");
static const u8 sHydrationDescription[] = _("Cures status problems in rain.");
static const u8 sNoGuardDescription[] = _("Never misses or avoids attacks.");
static const u8 sSolarPowerDescription[] = _("Raises SP. ATK and loses HP in sun.");
static const u8 sPranksterDescription[] = _("Gives status moves priority.");
static const u8 sMultiscaleDescription[] = _("Reduces damage taken at full HP.");
