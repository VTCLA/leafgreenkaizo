const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            ...
                            {EVO_ITEM, ITEM_DEEP_SEA_SCALE, SPECIES_GLACEON},
                            {EVO_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_SYLVEON}},
    ...
    [SPECIES_ROSELIA]    = {{EVO_LEVEL, 28, SPECIES_ROSERADE}},
    ...
    [SPECIES_CHINGLING]  = {{EVO_LEVEL, 24, SPECIES_CHIMECHO}},
    [SPECIES_BONSLY]     = {{EVO_LEVEL, 18, SPECIES_SUDOWOODO}},
    [SPECIES_MIME_JR]    = {{EVO_LEVEL, 18, SPECIES_MR_MIME}},
    [SPECIES_HAPPINY]    = {{EVO_LEVEL, 14, SPECIES_CHANSEY}},
    [SPECIES_MUNCHLAX]   = {{EVO_LEVEL, 28, SPECIES_SNORLAX}},
    [SPECIES_MANTYKE]    = {{EVO_LEVEL, 18, SPECIES_MANTINE}},
    [SPECIES_SNEASEL]    = {{EVO_LEVEL, 28, SPECIES_WEAVILE}},
    [SPECIES_MAGNETON]   = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_MAGNEZONE}},
    [SPECIES_LICKITUNG]  = {{EVO_LEVEL, 31, SPECIES_LICKILICKY}},
    [SPECIES_RHYDON]     = {{EVO_LEVEL, 38, SPECIES_RHYPERIOR}},
    [SPECIES_TANGELA]    = {{EVO_LEVEL, 31, SPECIES_TANGROWTH}},
    ...
    [SPECIES_YANMA]      = {{EVO_LEVEL, 26, SPECIES_YANMEGA}},
    [SPECIES_GLIGAR]     = {{EVO_LEVEL, 27, SPECIES_GLISCOR}},
    [SPECIES_PILOSWINE]  = {{EVO_LEVEL, 38, SPECIES_MAMOSWINE}},
    [SPECIES_PORYGON2]   = {{EVO_LEVEL, 38, SPECIES_PORYGON_Z}},
    [SPECIES_NOSEPASS]   = {{EVO_LEVEL, 31, SPECIES_PROBOPASS}},
    [SPECIES_DUSCLOPS]   = {{EVO_LEVEL, 38, SPECIES_DUSKNOIR}},
    [SPECIES_LINOONE]    = {{EVO_LEVEL, 38, SPECIES_OBSTAGOON}},
    [SPECIES_FARFETCHD]  = {{EVO_LEVEL, 28, SPECIES_SIRFETCHD}},
};
