...
//used for out of battle item use cutscene
//columns 1 and 2 are x and y coords respectively for the forehead on the frontpic
//columns 4 and 5 are x and y coords respectively for the mouth
static const u8 sMonSpriteAnchorCoords[][5] = {
    ...
    [SPECIES_BUDEW           - 1] = {0x1D, 0x1F, 0x30, 0x1C, 0x28},
    [SPECIES_ROSERADE        - 1] = {0x24, 0x11, 0x30, 0x24, 0x20},
    [SPECIES_AMBIPOM         - 1] = {0x18, 0x1a, 0x18, 0x18, 0x27},
    [SPECIES_MISMAGIUS       - 1] = {0x18, 0x0f, 0x08, 0x18, 0x1B},
    [SPECIES_HONCHKROW       - 1] = {0x1f, 0x0e, 0x30, 0x13, 0x19},
    [SPECIES_CHINGLING       - 1] = {0x1b, 0x1c, 0x10, 0x18, 0x2a},
    [SPECIES_BONSLY          - 1] = {0x1f, 0x15, 0x30, 0x15, 0x28},
    [SPECIES_MIME_JR         - 1] = {0x25, 0x14, 0x30, 0x1C, 0x26},
    [SPECIES_HAPPINY         - 1] = {0x1B, 0x17, 0x30, 0x19, 0x24},
    [SPECIES_MUNCHLAX        - 1] = {0x1C, 0x14, 0x30, 0x1c, 0x20},
    [SPECIES_MANTYKE         - 1] = {0x19, 0x18, 0x28, 0x15, 0x26},
    [SPECIES_WEAVILE         - 1] = {0x2a, 0x0a, 0x30, 0x2a, 0x21},
    [SPECIES_MAGNEZONE       - 1] = {0x19, 0x16, 0x08, 0x19, 0x2c},
    [SPECIES_LICKILICKY      - 1] = {0x1b, 0x06, 0x30, 0x16, 0x18},
    [SPECIES_RHYPERIOR       - 1] = {0x1F, 0x07, 0x20, 0x1B, 0x15},
    [SPECIES_TANGROWTH       - 1] = {0x18, 0x10, 0x30, 0x17, 0x27},
    [SPECIES_ELECTIVIRE      - 1] = {0x1d, 0x08, 0x30, 0x1b, 0x15},
    [SPECIES_MAGMORTAR       - 1] = {0x25, 0x0b, 0x28, 0x29, 0x1a},
    [SPECIES_TOGEKISS        - 1] = {0x16, 0x1a, 0x20, 0x13, 0x1c},
    [SPECIES_YANMEGA         - 1] = {0x17, 0x18, 0x28, 0x16, 0x2b},
    [SPECIES_LEAFEON         - 1] = {0x18, 0x11, 0x30, 0x15, 0x25},
    [SPECIES_GLACEON         - 1] = {0x10, 0x14, 0x30, 0x0d, 0x2d},
    [SPECIES_GLISCOR         - 1] = {0x1C, 0x0f, 0x08, 0x1a, 0x1C},
    [SPECIES_MAMOSWINE       - 1] = {0x1e, 0x06, 0x20, 0x17, 0x24},
    [SPECIES_PORYGON_Z       - 1] = {0x1C, 0x0d, 0x20, 0x15, 0x19},
    [SPECIES_GALLADE         - 1] = {0x1e, 0x0a, 0x28, 0x1D, 0x18},
    [SPECIES_DUSKNOIR        - 1] = {0x21, 0x0d, 0x20, 0x1D, 0x1F},
    [SPECIES_FROSLASS        - 1] = {0x24, 0x0d, 0x28, 0x21, 0x1e},
    [SPECIES_SYLVEON         - 1] = {0x16, 0x18, 0x30, 0x16, 0x25},
    [SPECIES_OBSTAGOON       - 1] = {0x10, 0x09, 0x28, 0x0e, 0x1a},
    [SPECIES_SIRFETCHD       - 1] = {0x1F, 0x17, 0x30, 0x1b, 0x23}
};
