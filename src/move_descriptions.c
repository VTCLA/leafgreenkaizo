...
const u8 gMoveDescription_IceHammer[] = _("A swinging fist\nattack that also\nlowers SPEED.");
const u8 gMoveDescription_ForcePalm[] = _("A shock wave\nattack that may\nparalyze the foe.");
const u8 gMoveDescription_AuraSphere[] = _("Attacks with\nan aura blast\nthat cannot be\nevaded.");
const u8 gMoveDescription_RockPolish[] = _("Polishes the\nbody to sharply\nraise SPEED.");
...
const u8 gMoveDescription_SeedBomb[] = _("A barrage of\nhard seeds is\nfired at the foe.");
...
const u8 gMoveDescription_DragonPulse[] = _("Generates a\nshock wave to\ndamage the foe.");
const u8 gMoveDescription_DragonRush[] = _("Tackles the foe\nwith menace. May\ncause flinching.");
const u8 gMoveDescription_PowerGem[] = _("Attacks with light\nrays that sparkle\nlike diamonds.");
...
const u8 gMoveDescription_IceShard[] = _("Hurls a chunk\nof ice that\nalways strikes first.");
...
const u8 gMoveDescription_ZenHeadbutt[] = _("Focuses its will\nand rams the foe.\nMay cause flinching.");
...
const u8 gMoveDescription_PowerWhip[] = _("Violently lashes\nwith vines or\ntentacles.");
const u8 gMoveDescription_GunkShot[] = _("Shoots filthy\ngarbage at the\nfoe. May poison.");
...
const u8 gMoveDescription_DoubleHit[] = _("Slams the foe\nwith a tail\netc. Strikes twice.");
const u8 gMoveDescription_OminousWind[] = _("A repulsive\nattack that may\nraise all stats.");
const u8 gMoveDescription_TailSlap[] = _("Strikes the foe\nwith its tail\n2 to 5 times.");
const u8 gMoveDescription_RagePowder[] = _("Scatters powder\nto make foes\nattack the user.");
const u8 gMoveDescription_LowSweep[] = _("Attacks the foe's\nlegs, lowering its\nSPEED.");
const u8 gMoveDescription_Scald[] = _("Shoots boiling water\nat the foe. May\ninflict a burn.");
const u8 gMoveDescription_Bulldoze[] = _("Stomps the ground,\nstriking all POKéMON\nand lowering\ntheir SPEED.");
const u8 gMoveDescription_Electroweb[] = _("Snares the foes\nwith an electric\nnet. Lowers SPEED.");
const u8 gMoveDescription_WildCharge[] = _("An electrical\ntackle that also\nhurts the user.");
...
const u8 gMoveDescription_DrainingKiss[] = _("Steals the target's\nenergy. Half the\ndamage is restored\nto the user.");
const u8 gMoveDescription_PlayRough[] = _("Plays rough with\nthe foe. May\nlower ATTACK.");
const u8 gMoveDescription_LavaPlume[] = _("Scarlet flames\ntorch everything\naround the user.");
const u8 gMoveDescription_LeafStorm[] = _("Whips up a storm\nof leaves. Harshly\nlowers the user's\nSP. ATK.");
const u8 gMoveDescription_DualWingbeat[] = _("User slams the\ntarget with wings.\nStrikes twice.");
...
const u8 gMoveDescription_Nuzzle[] = _("Rubs its cheeks\nagainst the foe,\nparalyzing it.");
const u8 gMoveDescription_Snarl[] = _("Yells and rants\nat the foe,\nlowering SP. ATK.");
const u8 gMoveDescription_Lunge[] = _("Lunges at the\nfoe and lowers\nits ATTACK.");
const u8 gMoveDescription_Accelerock[] = _("Hits with a\nhigh-speed rock\nthat always goes\nfirst.");
const u8 gMoveDescription_SpiritBreak[] = _("Attacks with a\nspirit-breaking\nforce. Lowers the\nSP. ATK. stat.");
const u8 gMoveDescription_FireLash[] = _("Whips the foe with\nfire, lowering its\nDEFENSE stat.");
const u8 gMoveDescription_ScorchingSands[] = _("Throws scorching\nsand at the\ntarget. May burn.");
const u8 gMoveDescription_Liquidation[] = _("Slams the foe\nwith water. Can\nlower DEFENSE.");
const u8 gMoveDescription_WaveCrash[] = _("A slam shrouded\nin water. Also\nhurts the user.");
const u8 gMoveDescription_SolarBlade[] = _("Charges first turn\nthen chops with a\nblade of light.");
const u8 gMoveDescription_RazorShell[] = _("Tears at the\nfoe with sharp\nshells. May lower\nDEFENSE.");
const u8 gMoveDescription_MysticalFire[] = _("Breathes a hot\notherworldly fire.\nLowers SP. ATK.");
